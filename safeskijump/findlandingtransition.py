...
""" this function calculates the coordinates of the transition point
from the safe landing surface to the transition surface back to the 
parent slope
"""
# jumper data
        xJ=stateJ[:,0];
        ...
        thetaJ=atan(dydxJ); # angle along design-speed jumper path
